#Just in case I need these imports
    ...
    while change2 == 1 and '?' in SudokuToSolve:
        ...
        while CheckingRow2 < 9: #which row(
            ...
            while CheckingElementRequirement < len(RowRequirements):#Which requirement(
                ...
                RowRequirements = list(set1to9 - set(SudokuToSolveRows[CheckingRow2]))
                RowRequirements = sorted(RowRequirements)
                RowRequirements = RowRequirements + [-1]
...
def FinalCheck():
    ...
    while LoopIndex7 < 9:
        ...
        if len(set(SudokuToSolveColumns[LoopIndex7]) - set('?')) != len(SudokuToSolveColumns[LoopIndex7]) - SudokuToSolveRows.count('?'):
            CheckingHelper2 = CheckingHelper2 + 1
        if len(set(SudokuToSolveSquares[LoopIndex7]) - set('?')) != len(SudokuToSolveSquares[LoopIndex7]) - SudokuToSolveRows.count('?'):
            CheckingHelper2 = CheckingHelper2 + 1
